...
DEST = ROOT / "EggplantRecorder/Assets.xcassets/AppIcon.appiconset"
CANDIDATES = [
    DEST / "AppIcon-1024-master.png",
    Path.home()
    / ".cursor/projects/Users-cyper-code-eggplant-projects-EggplantRecorder/assets/EggplantRecorder-AppIcon-1024-raw.png",
]
...
def main() -> None:
    # Prefer raw AI art when present so regenerating picks up a new design.
    raw = CANDIDATES[1]
    src = raw if raw.exists() else next((p for p in CANDIDATES if p.exists()), None)
    if src is None:
